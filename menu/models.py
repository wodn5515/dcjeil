...
class Submenu(models.Model):
    ...
    exposure_home = models.IntegerField(_('홈 화면 노출 여부'), default=0, help_text="<table style='text-align:center;'><tbody><tr><td colspan='2'>최근게시물</td></tr><tr><td>1</td><td>2</td></tr></tbody></table>")
